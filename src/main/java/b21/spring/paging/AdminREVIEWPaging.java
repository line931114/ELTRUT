...
public class AdminREVIEWPaging {
	...
	// 검색할 경우 페이징 생성자
	public AdminREVIEWPaging(int currentPage, int totalCount, int blockCount, int blockPage, String list, int searchNum, String isSearch) {
	...
	// Q&A 메인 페이징 처리 생성자
	public AdminREVIEWPaging(int currentPage, int totalCount, int blockCount, int blockPage, String list) {
	...
	public AdminREVIEWPaging(int currentPage, int totalCount, int blockCount, int blockPage, String list, Integer categoryNum, HttpServletRequest request) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
		this.blockCount = blockCount;
		this.blockPage = blockPage;
	...
	public AdminREVIEWPaging(int currentPage, int totalCount, int blockCount, int blockPage, HttpServletRequest request, String list, Integer repState) {
		this.currentPage = currentPage;
		this.totalCount = totalCount;
		this.blockCount = blockCount;
		this.blockPage = blockPage;
