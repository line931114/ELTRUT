...
인증
   ...
   <div class="col-md-4 imagebox">
      <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            ...
            <img class="d-block w-100" src="/ELTRUT/file/goodsFile/${GD.GOODS_THUMBNAIL}" alt="First slide">
              <div class="carousel-item">
            <img class="d-block w-100" src="/ELTRUT/file/goodsFile/${GD.GOODS_IMAGE_1}" alt="Third slide">
            </div>
             <div class="carousel-item">
            <img class="d-block w-100" src="/ELTRUT/file/goodsFile/${GD.GOODS_IMAGE_2 }" alt="Third slide">
           </div>
        </div>
    </div>
