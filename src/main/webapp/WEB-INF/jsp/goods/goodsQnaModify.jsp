...
<div class="container">
  <main>
    <div class="py-5 text-center">
      ...
      <h2>상품 QNA 수정하는 곳입니다.</h2>
      
    </div>
    <div class="row g-5">
      
      <div class="col-md-7 col-lg-8">
		<form class="needs-validation" method="post" name="qnaModify" action="/ELTRUT/goodsQnaModify" enctype="multipart/form-data">
          <div class="row g-3">
            <div class="col-7">
			...
			<div class="col-7">
              ...
              <select class="form-select" name="CS_CATEGORY" id="CS_CATEGORY">
            ...
            <div class="col-7">
              <label for="address" class="form-label">문의날짜</label>
          ...
          <button class="btn btn-primary btn-lg" type="button" onclick="location.href='/ELTRUT/goodsReview?GOODS_NUMBER=${O.GOODS_NUMBER }'">돌아가기</button>
          </div>
        </form>
      </div>
    </div>
