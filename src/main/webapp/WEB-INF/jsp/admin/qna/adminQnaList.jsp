							...
							<table class="table table-striped" id="dataTables-example" role="grid"
								...
								<c:url var="viewURL" value="adminQnaDetail" >
									...
									<tr class="gradeA even" role="row">
										<td style="text-align:center;vertical-align:middle;">${adminQnaList.CS_NUMBER}</td>
										<td style="text-align:center;vertical-align:middle;">${adminQnaList.CS_CATEGORY}</td>
										<td style="text-align:center;vertical-align:middle;">${adminQnaList.MEMBER_ID}</td>
										<td style="text-align:center;vertical-align:middle;">${adminQnaList.CS_TITLE}</td>
										<td style="text-align:center;vertical-align:middle;"><fmt:formatDate value="${adminQnaList.CS_REGDATE}" pattern="YY.MM.dd HH:mm" /></td>
										<td style="text-align:center;vertical-align:middle;">${adminQnaList.CS_REPSTATE }</td>
