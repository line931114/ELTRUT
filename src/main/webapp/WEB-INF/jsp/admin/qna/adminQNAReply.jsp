		...
		<div class="panel-body">
			<form:form id="frm" name="frm" action="frm" method="post" enctype="multipart/form-data" onsubmit="return joinValidation(this)">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="CS_CATEGORY" name="CS_CATEGORY" value="${qnaDetail.CS_CATEGORY}" style="width: initial;" />
				</div>
				<div class="form-group">
					<label>제목</label> 
					<input type="text" class="form-control" id="CS_TITLE" name="CS_TITLE" value="${qnaDetail.CS_TITLE}" style="width: initial;" />
				</div>
				<div class="form-group">
					<label>내용</label>
