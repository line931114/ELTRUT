               ...
               <div class="row" style="margin-bottom:5px;">
                  <div class="col-sm-6">
                     ...
                     <select class="form-control" name="select" onchange="window.open(value,'_self');">
                        ...
                        <option value ="adminGoodsList?searchNum=2&isSearch=OUTER">OUTER</option>
                        <option value ="adminGoodsList?searchNum=2&isSearch=TOP">TOP</option>
                        <option value ="adminGoodsList?searchNum=2&isSearch=DRESS">DRESS</option>
                        <option value ="adminGoodsList?searchNum=2&isSearch=KNIT">KNIT</option>
                        <option value ="adminGoodsList?searchNum=2&isSearch=T-SHIRTS">T-SHIRTS</option>
                        <option value ="adminGoodsList?searchNum=2&isSearch=PANTS">PANTS</option>
                        <option value ="adminGoodsList?searchNum=2&isSearch=SKIRTS">SKIRTS</option>
                        <option value ="adminGoodsList?searchNum=2&isSearch=SHOES">SHOES</option>
                        
                     </select>
                     <select class="form-control" name="select" onchange="window.open(value,'_self');">
                        <option value ="">--상품구분--</option>
                        <option value ="/ELTRUT/adminGoodsList?searchNum=3&isSearch=0">판매중</option>
                        <option value ="/ELTRUT/adminGoodsList?searchNum=4&isSearch=">품절상품</option>
                     </select>         
                     <select class="form-control" name="select" onchange="window.open(value,'_self');">
                        <option value ="">--상품정렬--</option>
                        <option value ="adminGoodsList?searchNum=5&isSearch=GOODS_AMOUNT">판매수량순</option>
                        <option value ="adminGoodsList?searchNum=6&isSearch=GOODS_COUNT">조회순</option>
                     </select>                                 
                  </div>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <table
                        ...
                        <c:url var="viewURL" value="adminModifyGoods" >
                           ...
                           <tr class="gradeA even" role="row">
                              ...
                              <td style="text-align:center;vertical-align:middle;">${adminGoodsList.GOODS_AMOUNT}개<div style='display:none;'>${adminGoodsList.GOODS_NUMBER}</div></td>
                              <td style="text-align:center;vertical-align:middle;">${adminGoodsList.GOODS_SELLCOUNT}개<div style='display:none;'>${adminGoodsList.GOODS_NUMBER}</div></td>
