					...
					<div class="row" style="margin-bottom:5px;">
						<div class="col-sm-6">
							...
							<select class="form-control" name="select" onchange="window.open(value,'_self');">
								...
								<option value ="/ELTRUT/admin/goods/adminGoodsList?searchNum=3&isSearch=0">판매중</option>
								<option value ="/ELTRUT/admin/goods/adminGoodsList?searchNum=4&isSearch=">품절상품</option>
							</select>			
							<select class="form-control" name="select" onchange="window.open(value,'_self');">
