...
<body>
    ...
    <div class="frame">
        ...
        <nav class="navigator">
            <a href="main0"><h3 class="site-name">ELTRUT- 정원철</h3></a>
        </nav>
    ...
    - 프로젝트 관리자 백엔드작업(회원목록,탈퇴한 회원목록,매출관리,취소관리) <br>
	+ tiles 기본설정 및 기능 구현 페이지 설정<br>
	+ 관리자 UI 총괄 + 전체적인 디자인 구성<br>
	- 프로젝트 문서화작업 (프로젝트 흐름도, 테이블설계 )
            </div>
        </div>
