...
<body>
    ...
    <div class="frame">
        ...
        <nav class="navigator">
            <a href="main0"><h3 class="site-name">ELTRUT- 정혜림</h3></a>
        </nav>
    ...
    - 데이터 자료사전 작성<br>
	- 프로젝트에서 사용될 SQL 쿼리문 테스트 및 디버깅<br>
	- 관리자입장 프로젝트 백엔드 작업  Goods, CS, QNA <br>
 	- 상품/게시글(+이미지) 조회, 등록, 수정, 삭제, 검색<br>
	- 상품관련 DB 작업<br>
	- 사용자 UI 디자인 작업 (css,부트스트랩활용) <br>
	- 프로젝트 PPT 작성<br>
