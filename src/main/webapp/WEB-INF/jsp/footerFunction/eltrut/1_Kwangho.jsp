...
<body>
    ...
    <div class="frame">
        ...
        <a href="main0"><h3 class="site-name">ELTRUT- 이광호</h3></a>
        </nav>
        ...
        <div class="profile-section">
            <img id="profile-picture" src="file/profile.jpg">
            <div class="introduction">
                <h2>ABOUT ME</h2>
                <p>" 뭐든 열심히 다 하는 인간 스타트업이 되도록 노력 중"
                <br>아이들을 가르치는 코딩 교육을 진행하다,코딩에 매력을 느껴 새롭게 제대로된 코딩을 배우고 싶어 Back-End를 공부 중입니다. 
                <br>무엇이든 시작하면 제대로 하는 성격 같이 즐겁게, 열정적으로 할 수 있는 사람입니다.</p>
                <h2>CAPABILITY</h2>
                <p style="text-align: left;">

    - 작업 툴 설정(디렉토리 설계에 맞춰서 패키지 및 폴더 생성)
    <br>    
    - 사용자입장 프로젝트 작업( 회원가입,아이디 비밀번호 찾기)
    <br>
     + 마이페이지 구매내역,구매후기,회원정보수정...등
    <br>    
     + Tiles address setting
    <br>
    - 코드 통합, 전체 코드 오류 디버깅 
    <br>
    - 문서화작업 (전체 쿼리, 테이블, ERD...등) 
    <br>
    - 오픈API 사용(다음 주소찾기 활용)
    </p>
	...
	- 부트스트랩,CSS 활용한 프론트엔드 제작 
        ...
        <footer class="footer">
            ...
            <div class="links">
                <a class="blog" href="https://blog.naver.com/dlrhkdgh3333">BLOG</a>
                <a class="instagram" href="https://www.instagram.com/dlrhkdxod/">INSTAGRAM</a>
