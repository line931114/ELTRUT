...
<body>
    ...
    <div class="frame">
        ...
        <nav class="navigator">
            <a href="main0"><h3 class="site-name">ELTRUT- 정세영</h3></a>
        </nav>
      ...
      - 관리자 쿼리 작성(관리자페이지에서 사용하는 쿼리작성)<br>    
	  - 사용자입장 프로젝트 작업( 로그인, 상품디테일, 장바구니, 주문, 결제, 결제완료)<br>
  	  - 마이페이지, 주문, 결제, 결제완료(프론트 엔드작업)<br>
  	  - 오픈API 사용(카카오페이)
  	  - JQUERY를 이용한 이용약관 팝업구현<br>
